<html>
    ...
    <div style="position:absolute; top:0px; width: 100%; height: 60px; text-align: center; background: white;z-index: 9999;">
        <img src="https://www.apretaste.org/images/apretaste_logo_300x108.png" height="50">
    </div>
    (( body ))
    <div style="position:absolute; bottom:0px; width: 100%; height: 100px;text-align: center;background: white;z-index: 9999;"">
            <div class="content">
