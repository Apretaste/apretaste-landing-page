<section class="spotlight style3 android orient-left content-align-left image-position-center onload-content-fade-down">
	<div class="content">
		...
		<form method="post" action="/invitar/submit">
			<div class="fields">
				<div class="field">
					<label for="name">Inserta tu nombre (para que sepan quien les invitó)</label>
					<input type="text" name="name" id="name" value="" required />
				</div>
				<div class="field">
					<label for="email">Inserta el correo de tu contacto en Cuba</label>
					<input type="email" name="email" id="email" value="" required />
				</div>
			</div>
			<ul class="actions">
				<li><input type="submit" class="button primary" value="Enviar invitación" /></li>
			</ul>
		</form>
	</div>
	<div class="image">
