...
function getFeatures () {
	return [
		...
		(Object) ["icon"=>"fa-mobile", "title"=>"Servicios", "text"=>"Noticias, Clima, Chistes, Juegos, Rifas, La Bolita, Religión, Deporte... Con decenas de servicios en Apretaste seguro encuentras lo que necesitas."]
	];
}
...
function getDownloadLink ($os) {
	...
	if($os == 'apk') return 'https://rebrand.ly/appcuba';
}
