...
<html>
	<head>
		...
		})(window,document,'script','dataLayer','GTM-WXPFQXV');</script>
	...
	<body class="is-preload">
		...
		<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WXPFQXV" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
